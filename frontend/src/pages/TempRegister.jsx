...
export default function SignUpPage() {
  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col bg-[var(--background-color)] text-[var(--text-primary)] overflow-x-hidden">
      {/* Header */}
      <header className="flex items-center justify-between border-b border-solid border-b-[var(--secondary-color)] px-10 py-4 shadow-lg">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 gap-y-6 gap-x-6 sm:grid-cols-2">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`form-input form-input-with-icon ${
                      ageError ? "border-red-500 focus:ring-red-500" : ""
                    }`}
                  />
                </div>
                {ageError && (
              ...
              <div className="sm:col-span-2">
                ...
                <div className="relative">
                  <MdTrendingUp className="input-icon" />
                  <select
                    id="experience"
                    name="experience"
