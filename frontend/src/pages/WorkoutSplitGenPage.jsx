...
const PopularSplits = () => (
  <div className="bg-gradient-to-br from-slate-900/80 to-slate-800/80 backdrop-blur-xl rounded-3xl p-6 border border-white/10 shadow-2xl">
    <div className="flex items-center gap-3 mb-6">
      <div className="w-8 h-8 bg-gradient-to-r from-purple-500 to-pink-500 rounded-xl flex items-center justify-center">
        <TrendingUp className="w-4 h-4 text-white" />
      </div>
      <h3 className="text-lg font-bold text-white">Popular Splits</h3>
    </div>
      ...
      <div className="flex-1 p-8 ml-72">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-4 mb-6">
            <h1 className="text-4xl font-black bg-white bg-clip-text text-transparent">
        ...
        <div className="flex gap-8">
          {/* Main Generator */}
          <div className="flex-1 bg-gradient-to-br from-slate-900/60 to-slate-800/60 backdrop-blur-xl rounded-3xl p-8 border border-white/10 shadow-2xl">

            {/* Tab Navigation */}
            <div className="flex gap-2 mb-8 p-1 bg-slate-800/50 rounded-2xl border border-white/5">
              {[
            ...
            {activeTab === "generator" ? (
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-4 gap-4 mb-8">
                  {[
                    ...
                    <div key={i} className="p-4 bg-gradient-to-br from-slate-800/80 to-slate-700/80 rounded-2xl border border-white/10">
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full p-4 rounded-2xl bg-slate-800/80 border border-white/10 focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 outline-none text-white placeholder:text-slate-500 transition-all backdrop-blur-sm"
                  ...
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      className="w-full p-4 rounded-2xl bg-slate-800/80 border border-white/10 focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 outline-none text-white transition-all backdrop-blur-sm"
                    >
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows="3"
                    className="w-full p-4 rounded-2xl bg-slate-800/80 border border-white/10 focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 outline-none text-white placeholder:text-slate-500 transition-all backdrop-blur-sm resize-none"
                ...
                <div className="flex justify-center pt-4">
                  <button
                    ...
                    className="group relative px-8 py-4 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-white font-bold rounded-2xl shadow-2xl shadow-blue-500/25 hover:shadow-blue-500/40 transition-all duration-300 disabled:opacity-70 disabled:cursor-not-allowed overflow-hidden"
                  >
                    ...
                    <div className="relative flex items-center gap-3">
                      {isGenerating ? (
                        <>
                          ...
                          <span>Generating your split...</span>
                        </>
                      ) : (
                        <>
              ...
              <div className="text-center py-16">
                ...
                <h3 className="text-xl font-semibold text-white mb-2">Workout Templates</h3>
                <p className="text-slate-400">Pre-made workout templates coming soon!</p>
              </div>
            )}
            ...
            {/* Results */}
            <div className="mt-8 bg-gradient-to-br from-slate-900/80 to-slate-800/80 backdrop-blur-xl rounded-3xl p-6 border border-white/10 min-h-[200px]">
              {isGenerating ? (
                <div className="flex flex-col items-center justify-center h-48">
                  ...
                  <p className="text-slate-300 font-medium">Creating your personalized workout...</p>
                ...
                <div className="space-y-6">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h3 className="text-xl font-bold text-white">Your AI-Generated Workout</h3>
                  </div>

                  {generatedSplit.day.map((dayObj, idx) => (
                    <div
                      key={idx}
                      className="bg-gradient-to-r from-slate-800/80 to-slate-700/80 rounded-2xl p-6 border border-white/10 hover:border-white/20 transition-all"
                    >
                      ...
                      <div className="grid gap-4">
                        {dayObj.workouts.map((w, i) => (
                          <div
                            key={i}
                            className="p-4 bg-slate-900/60 rounded-xl border border-white/5 hover:border-white/10 transition-all"
                          >
                            <div className="flex items-start justify-between mb-2">
                              <h5 className="font-semibold text-white">{w.title}</h5>
                              <span className="text-xs bg-blue-500/20 text-blue-300 px-2 py-1 rounded-full">
                                {w.exercisecategory}
                              </span>
                            </div>
                            <p className="text-sm text-slate-400 mb-3">{w.exercisedesc}</p>
                ...
                <div className="flex flex-col items-center justify-center h-48 text-center">
                  ...
                  <p className="text-slate-400 font-medium">Ready to create your workout?</p>
                  <p className="text-slate-500 text-sm mt-1">Fill out the form above and click generate</p>
                </div>
              )}
            </div>
          </div>
