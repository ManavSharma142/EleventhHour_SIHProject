...
// import { Home, Dumbbell, Apple, Users, Coins, ChevronRight, Send } from "lucide-react"
// // import "./Community.css"

// export default function Community() {
//   return (
//     // <div className="community min-h-screen flex">
//     <div className="min-h-screen bg-gray-100 text-gray-900 flex">
//       {/* Sidebar */}
//       <div className="w-64 bg-gray-900 text-white border-r border-gray-800 p-6">
//         {/* Logo */}
...
//             <div className="p-6 bg-white border border-blue-600 rounded-xl shadow">
//               <h3 className="text-lg font-medium mb-4">
//                 How much does "Time Under Tension" actually matters ?
//               </h3>
...
//               <h3 className="text-lg font-medium mb-4">
//                 What's the ideal frequency of training each muscle group per week?
//               </h3>
//               <div className="flex justify-end">
//                 <button className="text-blue-600">Read more...</button>
//               </div>
...
//             <div className="p-6 bg-white rounded-xl shadow">
//               <h3 className="text-lg font-medium mb-4">
//                 Are Lengthened-partials actually worth it or just a hype ?
//               </h3>
//               <div className="flex justify-end">
//                 <button className="text-blue-600">Read more...</button>
//               </div>
...
//         {/* Chat Section */}
//         <div className="w-80 p-6 border-l border-gray-300 bg-gray-50">
//           <div className="mb-6">
//             <h2 className="text-xl font-semibold mb-1">Chat with Community</h2>
//             <p className="text-sm text-gray-500">Here's what others say</p>
//           </div>
...
//                 U
//               </div>
//               <div className="bg-blue-600 text-white px-3 py-2 rounded-lg text-sm max-w-[200px]">
//                 I'm doing my first arm preparation so can't do gym
//               </div>
//             </div>

//             <div className="text-sm text-gray-600 pl-11">Same bro</div>
//             <div className="text-sm text-gray-600 pl-11">bro dont do, instead learn galang</div>
//             <div className="text-sm text-gray-600 pl-11">eat 5 star and do nothing</div>
//             <div className="text-sm text-gray-600 pl-11">dairy hilk better</div>

//             <div className="bg-blue-600 text-white px-3 py-2 rounded-lg text-sm inline-block">
//               hilkek also butter
//             </div>

//             <div className="bg-blue-600 text-white px-3 py-2 rounded-lg text-sm inline-block">
//               Why are we so focus on example
//             </div>
//           </div>
